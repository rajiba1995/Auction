                                            ...
                                            <div class="rating-inputs show" id="ratingInputsAuctioneer">
                                                ...
                                                <div class="row input-row">
                                                    <div class="col-12">
                                                        ...
                                                        <input type="hidden" name="on_time_payment" value="1">
                                                        <ul class="rating-stars">
                                                            <li class="star three" onclick="giveRating(this,1)">
                                                                <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" width="512" height="512" x="0" y="0" viewBox="0 0 32 32" style="enable-background:new 0 0 512 512" xml:space="preserve" class=""><g><path d="m29.911 13.75-6.229 6.072 1.471 8.576a1 1 0 0 1-1.451 1.054L16 25.403l-7.701 4.048a1 1 0 0 1-1.451-1.054l1.471-8.576-6.23-6.071a1 1 0 0 1 .555-1.706l8.609-1.25 3.85-7.802c.337-.683 1.457-.683 1.794 0l3.85 7.802 8.609 1.25a1.002 1.002 0 0 1 .555 1.706z" fill="#000000" opacity="1" data-original="#000000" class="" style="
                                                                    "></path></g></svg>
                                                ...
                                                <div class="row input-row">
                                                    <div class="col-12">
                                                        ...
                                                        <input type="hidden" name="post_delivery_cooperation" value="2">
                                                        <ul class="rating-stars">
                                                            <li class="star three" onclick="giveRating(this,1)">
                                                                <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" width="512" height="512" x="0" y="0" viewBox="0 0 32 32" style="enable-background:new 0 0 512 512" xml:space="preserve" class=""><g><path d="m29.911 13.75-6.229 6.072 1.471 8.576a1 1 0 0 1-1.451 1.054L16 25.403l-7.701 4.048a1 1 0 0 1-1.451-1.054l1.471-8.576-6.23-6.071a1 1 0 0 1 .555-1.706l8.609-1.25 3.85-7.802c.337-.683 1.457-.683 1.794 0l3.85 7.802 8.609 1.25a1.002 1.002 0 0 1 .555 1.706z" fill="#000000" opacity="1" data-original="#000000" class="" style="
                                                                    "></path></g></svg>
                                                ...
                                                <div class="row input-row">
                                                    <div class="col-12">
                                                        ...
                                                        <input type="hidden" name="genuiness" value="3">
                                                ...
                                                <div class="row input-row">
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            <textarea class="form-control border-red review" name="buyer_message" placeholder="Write a review">{{ old('buyer_message') }}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="rating-inputs" id="ratingInputsBidder">
                                                ...
                                                <div class="row input-row">
                                                    <div class="col-12">
                                                        ...
                                                        <input type="hidden" name="on_time_delivery" value="1">
                                                        <ul class="rating-stars">
                                                            <li class="star three" onclick="giveRating(this,1)">
                                                                <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" width="512" height="512" x="0" y="0" viewBox="0 0 32 32" style="enable-background:new 0 0 512 512" xml:space="preserve" class=""><g><path d="m29.911 13.75-6.229 6.072 1.471 8.576a1 1 0 0 1-1.451 1.054L16 25.403l-7.701 4.048a1 1 0 0 1-1.451-1.054l1.471-8.576-6.23-6.071a1 1 0 0 1 .555-1.706l8.609-1.25 3.85-7.802c.337-.683 1.457-.683 1.794 0l3.85 7.802 8.609 1.25a1.002 1.002 0 0 1 .555 1.706z" fill="#000000" opacity="1" data-original="#000000" class="" style="
                                                                    "></path></g></svg>
                                                ...
                                                <div class="row input-row">
                                                    <div class="col-12">
                                                        ...
                                                        <input type="hidden" name="right_product" value="2">
                                                        <ul class="rating-stars">
                                                            <li class="star three" onclick="giveRating(this,1)">
                                                                <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" width="512" height="512" x="0" y="0" viewBox="0 0 32 32" style="enable-background:new 0 0 512 512" xml:space="preserve" class=""><g><path d="m29.911 13.75-6.229 6.072 1.471 8.576a1 1 0 0 1-1.451 1.054L16 25.403l-7.701 4.048a1 1 0 0 1-1.451-1.054l1.471-8.576-6.23-6.071a1 1 0 0 1 .555-1.706l8.609-1.25 3.85-7.802c.337-.683 1.457-.683 1.794 0l3.85 7.802 8.609 1.25a1.002 1.002 0 0 1 .555 1.706z" fill="#000000" opacity="1" data-original="#000000" class="" style="
                                                                    "></path></g></svg>
                                                ...
                                                <div class="row input-row">
                                                    <div class="col-12">
                                                        ...
                                                        <input type="hidden" name="post_delivery_service" value="3">
                                                        <ul class="rating-stars">
                                                            <li class="star three" onclick="giveRating(this,1)">
                                                                <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" width="512" height="512" x="0" y="0" viewBox="0 0 32 32" style="enable-background:new 0 0 512 512" xml:space="preserve" class=""><g><path d="m29.911 13.75-6.229 6.072 1.471 8.576a1 1 0 0 1-1.451 1.054L16 25.403l-7.701 4.048a1 1 0 0 1-1.451-1.054l1.471-8.576-6.23-6.071a1 1 0 0 1 .555-1.706l8.609-1.25 3.85-7.802c.337-.683 1.457-.683 1.794 0l3.85 7.802 8.609 1.25a1.002 1.002 0 0 1 .555 1.706z" fill="#000000" opacity="1" data-original="#000000" class="" style="
                                                                    "></path></g></svg>
                                                ...
                                                <div class="row input-row">
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            <textarea class="form-control border-red review" name="seller_message" placeholder="Write a review">{{ old('seller_message') }}</textarea>
