                                        ...
                                        <table class="table inquiry-wrapper-table">
                                            ...
                                            @if ($pending_inquiries)
                                                @foreach($pending_inquiries as $item)
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td class="comments-td">
                                                                            <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#pending_CommentModal{{$item->id}}" class="btn btn-view btn-view-comment">
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td class="other-actions-td">
                                                                            <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#pending_cancelInquiryModal{{$item->id}}" class="btn btn-red btn-cancel-inquiry">
                                                    ...
                                                    {{--pending add comment modal --}}
                                                            <div class="modal fade add-comment-modal" id="pending_CommentModal{{$item->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                ...
                                                <div class="modal fade allot-rate-modal cancel-inquiry" id="pending_cancelInquiryModal{{$item->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
