                                        ...
                                        <table class="table table-striped inquiry-wrapper-table all-inquiry-wrapper-table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="input-title-td">{{ $item->InquriesData->title}}</td>
                                                    ...
                                                    <td class="input-location-td">{{$item->InquriesData->location}}</td>
                                                    ...
                                                    <td class="min-quote-td">{{$item->InquriesData->minimum_quote_amount}}</td>
                                                    <td class="max-quote-td">{{$item->InquriesData->maximum_quote_amount}}</td></td>
