    ...
    <div class="inner-page">
        ...
        <section class="user-dashboard">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <ul class="nav nav-tabs dashboard-tabs" id="dashboardTabs" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="savedinquiries-tab" data-bs-toggle="tab" data-bs-target="#savedinquiries" type="button" role="tab" aria-controls="savedinquiries" aria-selected="false">
                                        Saved Inquiries
                                        <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="tab-content dashboard-tab-content">
                            ...
                            <div class="col-12">
                                <ul class="dashboard-groups">
                                    <li>
                                        ...
                                        <div class="group-name">Transport Service (5)</div>
                                        <a href="auction-inquiry-generation-form.html" class="btn btn-animated btn-view bg-green">Open</a>
                                        <a href="auction-inquiry-generation-form.html" class="btn btn-animated btn-yellow btn-inquiry">Start Inquiry</a>
                                    </li>
                                    <li>
                                        <div class="group-icon">
                                            <img src="assets/images/group.png" alt="Group">
                                        </div>
                                        <div class="group-name">AC Repair (3)</div>
                                        <a href="auction-inquiry-generation-form.html" class="btn btn-animated btn-view bg-green">Open</a>
                                        <a href="auction-inquiry-generation-form.html" class="btn btn-animated btn-yellow btn-inquiry">Start Inquiry</a>
                                    </li>
                                    <li>
                                        ...
                                        <div class="group-name">My Favorites (15)</div>
                                        <a href="auction-inquiry-generation-form.html" class="btn btn-animated btn-view bg-green">Open</a>
                                        <a href="auction-inquiry-generation-form.html" class="btn btn-animated btn-yellow btn-inquiry">Start Inquiry</a>
                                    </li>
                                    <li>
                                        ...
                                        <div class="group-name">Transport</div>
                                        <a href="auction-inquiry-generation-form.html" class="btn btn-animated btn-view bg-green">Open</a>
                                        <a href="auction-inquiry-generation-form.html" class="btn btn-animated btn-yellow btn-inquiry">Start Inquiry</a>
                                    </li>
                                    <li>
                                        ...
                                        <div class="group-name">Television (9)</div>
                                        <a href="auction-inquiry-generation-form.html" class="btn btn-animated btn-view bg-green">Open</a>
                                        <a href="auction-inquiry-generation-form.html" class="btn btn-animated btn-yellow btn-inquiry">Start Inquiry</a>
                                    </li>
                                    <li>
                ...
                <div class="tab-pane fade" id="savedinquiries" role="tabpanel" aria-labelledby="savedinquiries-tab" tabindex="0">
                    <div class="container">
                        <div class="row">
                            <div class="col-12">
                                <ul class="dashboard-groups">
                                    <li>
                                        <div class="group-icon">
                                            <img src="assets/images/file-edit.png" alt="Group">
                                        </div>
                                        <div class="group-name">Transport Service</div>
                                        <a href="auction-inquiry-generation-form.html" class="btn btn-animated btn-yellow btn-inquiry">Open Inquiry</a>
                                    </li>
                                    <li>
                                        <div class="group-icon">
                                            <img src="assets/images/file-edit.png" alt="Group">
                                        </div>
                                        <div class="group-name">AC Repair</div>
                                        <a href="auction-inquiry-generation-form.html" class="btn btn-animated btn-yellow btn-inquiry">Open Inquiry</a>
                                    </li>
                                    <li>
                                        <div class="group-icon">
                                        ...
                                        <div class="group-name">Television Purchase</div>
                                        <a href="auction-inquiry-generation-form.html" class="btn btn-animated btn-yellow btn-inquiry">Open Inquiry</a>
                                    </li>
                                    <li>
                                        <div class="group-icon">
                                    ...
                                    <li>
                                        ...
                                        <div class="group-name">Television</div>
                                        <a href="auction-inquiry-generation-form.html" class="btn btn-animated btn-yellow btn-inquiry">Open Inquiry</a>
                                    </li>
                                    <li>
                                        <div class="group-icon">
                                    ...
                                    <li>
                                        ...
                                        <div class="group-name">Refrigerator</div>
                                        <a href="auction-inquiry-generation-form.html" class="btn btn-animated btn-yellow btn-inquiry">Open Inquiry</a>
                                    </li>
                                    <li>
                                        <div class="group-icon">
                                        ...
                                        <div class="group-name">Home Appliances</div>
                                        <a href="auction-inquiry-generation-form.html" class="btn btn-animated btn-yellow btn-inquiry">Open Inquiry</a>
                                    </li>
                                </ul>
                            </div>
                ...
                <div class="tab-pane fade" id="liveinquiries" role="tabpanel" aria-labelledby="liveinquiries-tab" tabindex="0">
                                            ...
                                            <tr>
                                                <td class="input-table-column" colspan="7">
                                                    <table class="table input-table">
                                                        <tbody>
                                                            <tr>
                                                                <td class="input-id-td">156897</td>
                                                                <td class="input-title-td">Transport Service</td>
                ...
                <div class="tab-pane fade" id="pendingresults" role="tabpanel" aria-labelledby="pendingresults-tab" tabindex="0">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-12">
                                <div class="table-responsive inquiry-tables">
                                                    ...
                                                    <table class="table input-table">
                                                        <tbody>
                                                            <tr>
                                                                <td class="input-id-td">156897</td>
                                                                <td class="input-title-td">Transport Service</td>
                                                                <td class="input-details-td"><a href="" class="btn btn-view">View</a></td>
                                                                <td class="input-start-date-td">25 jan, 2024</td>
                                                                <td class="input-end-date-td">28 jan, 2024</td>
                                                                <td class="min-quote-td">2,00,000</td>
                                                                <td class="max-quote-td">3,00,000</td>
                ...
                <div class="tab-pane fade" id="confirmed" role="tabpanel" aria-labelledby="confirmed-tab" tabindex="0">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-12">
                                <div class="table-responsive inquiry-tables">
                                                            ...
                                                            <tr>
                                                                <td class="other-actions-td">
                                                                    ...
                                                                    <a href="javascript:void(0)" class="btn btn-blue btn-restart-auction">
                                                                        <img src="assets/images/white-circle-tick.png" alt="Allot Offline">
                                                                        Restart Inquiry
                                                                    </a>
                                                                </td>
                                                            </tr>
