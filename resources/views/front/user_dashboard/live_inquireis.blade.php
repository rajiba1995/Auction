                                    ...
                                    <table class="table inquiry-wrapper-table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="input-th input-details-th" width="15%">Details</th>
                                        ...
                                        <tbody>
                                            @forelse($live_inquiries as $item)
                                            <tr>
                                                    ...
                                                    <table class="table input-table">
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td class="input-details-td" width="20%">
...
@forelse($live_inquiries as $itemData)
    <script>
    $(document).ready(function() {
