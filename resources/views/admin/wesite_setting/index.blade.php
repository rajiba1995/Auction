           ...
           {{-- {{dd($data)}} --}}
                        ...
                        <form action="{{ route('admin.website-settings.update') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col">
                            <div class="mb-3">
                                <label for="official_phone1">Official contact number 1 <span class="star">*</span></label>
                        ...
                        <div class="col">
                            <div class="mb-3">
                                <label for="official_email">Official email <span id=><span class="star">*</span></span></label>
                        ...
                        <div class="col">
                            <div class="mb-3">
                                <label for="website_link">Website <span class="star">*</span></label>
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="col">
                                <div class="mb-3">
                                <label for="company_favicon">Company Fav-icon<span class="star">*</span></label>&nbsp;&nbsp;
                            ...
                            <div class="mb-3">
                                <label for="company_short_desc">Short Company description <span class="star">*</span></label>
                            ...
                            <div class="mb-3">
                                <label for="company_full_address">Full Company address <span class="star">*</span></label>
